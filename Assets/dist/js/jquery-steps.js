...
(function (global, factory) {
  ...
  var Steps = /*#__PURE__*/ (function () {
    function Steps(element, options) {
      ...
      this.stepSelector = "".concat(
        this.options.stepSelector,
        " [data-step-target]"
      );
      this.footerSelector = "".concat(
        this.options.footerSelector,
        " [data-step-action]"
      );
      this.contentSelector = "".concat(
      ...
      [
        {
          ...
          value: function stepClick(e) {
            ...
            var next =
              $__default["default"](this).closest("[data-step-target]");
        ...
        },
        {
          ...
          value: function init() {
            ...
            $__default["default"](this.el).find(this.stepSelector).on(
              "click",
              {
                self: self,
              },
            ...
            $__default["default"](this.el).find(this.footerSelector).on(
              "click",
              {
                self: self,
              },
            ...
            this.setActiveStep(0, this.options.startAt, false);
        ...
        },
        {
          ...
          value: function destroy() {
            ...
            $__default["default"](this.el)
              .find(this.footerSelector)
              .off("click");
        ...
        },
        {
          ...
          value: function getStepIndex() {
            ...
            var stepIndex = all.index(
              all.filter(
                ".".concat(this.options.activeClass.split(" ").join("."))
              )
            );
            return stepIndex;
          },
        ...
        },
        {
          ...
          value: function setActiveStep(currentIndex, newIndex) {
            ...
            if (newIndex !== currentIndex || init) {
              ...
              var conditionIncrementOrDecrement =
                newIndex > currentIndex
                  ? function (start) {
                      var s = start;
                      s += 1;
              ...
              while (conditionDirection(i)) {
                ...
                if (i === newIndex) {
                  ...
                  var checkDone =
                    stepDirection === "forward" && this.options.doneClass;
                  this.setShowStep(
                    i,
                    ""
                ...
                var validStep = this.options.onChange(
                  i,
                  newIndex,
                  stepDirection
                );
  ...
  $__default["default"].fn.steps = function (options) {
    return this.each(function () {
      if (!$__default["default"].data(this, "plugin_Steps")) {
        $__default["default"].data(
          this,
          "plugin_Steps",
          new Steps(this, options)
        );
      }
    });
  };

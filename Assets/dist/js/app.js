...
$.fn.AdminSettings = function (settings) {
    ...
    var defaults = {
        ...
        Brand: 'skin6', // You can change the Value to be skin1/skin2/skin3/skin4/skin5/skin6 
    ...
    var AdminSettings = {
        ...
        ManageThemeBackground: function () {
            ...
            function setbrand() {
                var lbg = settings.Brand;
                if (lbg != undefined && lbg != "") {
                    $('#' + myid + ' .entry-list-section .entry-form-box').attr("data-brand", lbg);
                }
                else {
                    $('#' + myid + ' .entry-list-section .entry-form-box').attr("data-brand", "skin1");
                }
            };
            setbrand();
